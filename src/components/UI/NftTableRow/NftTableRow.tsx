...
const NftTableRow = ({
  ...
  return (
    <tr className={styles.row}>
      ...
      >
        <span aria-hidden="true" className={styles.row__cellLabel}>Rarity:</span>{" "}
        <span>{level}</span>
      </td>
      <td
        headers="games"
      ...
      >
        <span aria-hidden="true" className={styles.row__cellLabel}>Total games:</span>
        <span>{games}</span>
      </td>
      <td
        headers="win"
      ...
      >
        <span aria-hidden="true" className={styles.row__cellLabel}>Games Won:</span>
        <span>{win}</span>
      </td>
      <td
        headers="price"
